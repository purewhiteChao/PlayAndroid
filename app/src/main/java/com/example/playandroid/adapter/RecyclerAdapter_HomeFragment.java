 ...
 * Describe: ${as}
 */
public class RecyclerAdapter_HomeFragment extends RecyclerView.Adapter<RecyclerAdapter_HomeFragment.MyViewHolder> {
    private List<HomeRecyclerViewBean.DataBean.DatasBean> list = new ArrayList<>();
    private Context context;
    private CollectTableDao dao;

    public void refresh(List<HomeRecyclerViewBean.DataBean.DatasBean> list){
